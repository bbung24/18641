...
public class RemoteClientConstants {
	...
	public final static String LOGIN_PW = "Login_PW";
	
	public final static String REGISTER_CHECK_ID = "Check ID";
	public final static String REGISTER_CHECK_ID_FAIL = "Invalid ID";
	public final static String REGISTER_CHECK_ID_SUCCESS = "Valid ID";
	...
	public final static String REGISTSER_INFO_ID = "ID";
	public final static String REGISTSER_INFO_PW = "Password";
	public final static String REGISTSER_INFO_AGE = "Age";
	public final static String REGISTSER_INFO_ZIP = "Zipcode";
